        ...
        return(
            ...
            >
                <div className='relative rounded-xl overflow-hidden mb-2'>
                      ...
                      />
                   <div className="play-overplay absolute inset-0 bg-background/60 flex items-center justify-center">
        ...
        <div className="glass-panel p-3 song-card-hover group cursor-pointer hover:shadow-glow-sm transition-all duration-300"
         onClick={()=>onPlay(song)}>
            <div className="relative rounded-lg overflow-hidden mb-3">
                ...
                className="w-full aspect-square object-cover"
                />
                <div className="play-overlay absolute inset-0 bg-background/60 flex items-center justify-center">
            ...
            <h3 className="text-sm font-semibold truncate text-foreground">{song.title}</h3>
